namespace ComputeShaderUtility
{
	...
	public static class ComputeHelper
	{
		...
		public const GraphicsFormat defaultGraphicsFormat = GraphicsFormat.R8G8B8_UNorm; //GraphicsFormat.R8G8B8A8_UNorm;
		...
		{
			Debug.Log("CH:  Dispatch, kernelIndex: "+kernelIndex);
		...
		{
            Debug.Log("CH:  CreateStructuredBuffer");
		...
		{
            Debug.Log("CH: Release");
            for (int i = 0; i < buffers.Length; i++)
			{
				if (buffers[i] != null)
				{
                    Debug.Log("buffers[i] != null");
                    buffers[i].Release();
				}
			}
		}
		...
		{
            Debug.Log("CH: GetThreadGroupSizes, kernelIndex = "+ kernelIndex);
            uint x, y, z;
		...
		{
			Debug.Log("CH: CreateRenderTexture");
		...
		{
            Debug.Log("CH: CopyRenderTexture");
		...
		{
            Debug.Log("CH: SwizzleTexture");
            if (swizzleTextureCompute == null)
			{
                Debug.Log("CH: swizzleTextureCompute == null");
        ...
        {
            Debug.Log("CH: ClearRenderTexture");
            if (clearTextureCompute == null)
			{
                Debug.Log("CH: clearTextureCompute == null");
		...
		public static void NormalizeRenderTexture(RenderTexture source)
		{
			...
			{
                Debug.Log("normalizeTextureCompute == null");
